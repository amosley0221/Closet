...
const IMPORT_STORES = ['All', 'SNKRS', 'GOAT', 'Nike', 'H&M', 'COS', "Levi's", 'Mitchell & Ness', 'Carhartt WIP', 'Uniqlo'];
const CATALOG = [
  { id: 'c1', store: 'SNKRS', brand: 'Jordan', name: 'Air Jordan 3 “White Cement”', cat: 'Footwear', tone: '#E9E5DE', tone2: '#B23A2E', price: 210, sneaker: true },
  { id: 'c2', store: 'GOAT', brand: 'Nike', name: 'Air Max 90 “Infrared”', cat: 'Footwear', tone: '#D8D3CA', tone2: '#B23A2E', price: 140, sneaker: true },
  { id: 'c3', store: 'Mitchell & Ness', brand: 'Mitchell & Ness', name: 'Bulls Snapback', cat: 'Hats', tone: '#B23A2E', price: 34 },
  { id: 'c4', store: 'H&M', brand: 'H&M', name: 'Relaxed Heavy Hoodie', cat: 'Tops', tone: '#3B3A36', price: 30 },
  { id: 'c5', store: 'H&M', brand: 'H&M', name: 'Wide-Leg Cargo', cat: 'Bottoms', tone: '#6B6553', price: 40 },
  { id: 'c6', store: 'COS', brand: 'COS', name: 'Boiled-Wool Overcoat', cat: 'Outerwear', tone: '#2C2A26', price: 225 },
  { id: 'c7', store: "Levi's", brand: "Levi's", name: '501 Original Fit', cat: 'Bottoms', tone: '#3A4252', price: 98 },
  { id: 'c8', store: 'Carhartt WIP', brand: 'Carhartt', name: 'Nimbus Pullover', cat: 'Outerwear', tone: '#7C7556', price: 158 },
  { id: 'c9', store: 'Nike', brand: 'Nike', name: 'Tech Fleece Joggers', cat: 'Bottoms', tone: '#201F1C', price: 120 },
  { id: 'c10', store: 'GOAT', brand: 'New Balance', name: '1906R', cat: 'Footwear', tone: '#C9CCD2', tone2: '#9CA98C', price: 160, sneaker: true },
  { id: 'c11', store: 'SNKRS', brand: 'Jordan', name: 'Jordan 1 Mid “Royal”', cat: 'Footwear', tone: '#3A4252', price: 135, sneaker: true },
  { id: 'c12', store: 'Uniqlo', brand: 'Uniqlo', name: 'Supima Crew Tee', cat: 'Tops', tone: '#F1ECE3', price: 15 },
  { id: 'c13', store: 'COS', brand: 'COS', name: 'Twin-Tipped Polo', cat: 'Tops', tone: '#1C4A3A', price: 80 },
  { id: 'c14', store: 'Mitchell & Ness', brand: 'Mitchell & Ness', name: 'Lakers Warm-Up Jacket', cat: 'Outerwear', tone: '#5B3A8E', price: 120 },
];
